...
public:
   virtual int render(Renderer *renderer, glm::mat4 rendermat,glm::mat4 viewrendermat,bool renderMirror,bool reflectScene,glm::vec4 plane = glm::vec4(0,0,1,0)) const = 0;
